...
class Timer(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.one_minute = 45
        self.time = tk.IntVar() # holds integer data, retrieves the data.
        self.time.set(self.one_minute)
        self.timerLabel = None
        self.createTimer()
        self.updateTime()
    def createTimer(self):
        self.timerLabel = tk.Label(self, text=str(self.time.get()), font=("TkDefaultFont", 40), bg='black', fg='white', relief=tk.SUNKEN, bd=5)
